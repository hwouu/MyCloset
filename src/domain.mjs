...
export function createBackupPayload(data, preferences = {}, exportedAt = new Date().toISOString()) {
  return {
    ...
    preferences: {
      ...
      ...(preferences.currentView ? { currentView: preferences.currentView } : {}),
      ...(preferences.settingsTab ? { settingsTab: preferences.settingsTab } : {}),
      ...(preferences.wardrobeView ? { wardrobeView: preferences.wardrobeView } : {}),
      ...(preferences.outfitSort ? { outfitSort: preferences.outfitSort } : {}),
